...
class HuobiProDepthSpider(object):
    ...
    def save_result_redis(self, result):
        ...
        if result.get("ch"):
            ...
            redis_key_name = "huobipro:spot:depth:{}_{}_depth_100".format(self.pair1, self.pair2)
            while True:
                try:
    ...
    if pair_url_spot:
        ...
        for depth_info in depth_info_spot:
            ...
            for index, symbol in enumerate(symbol_list):
                ...
                spider = HuobiProDepthSpider(logger, symbol, exchange, req, depth_type, pair1, pair2)
