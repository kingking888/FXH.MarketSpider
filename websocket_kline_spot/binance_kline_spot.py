...
class BinanceKlineSpider(object):
    ...
    def task_thread(self):
        ...
        while True:
            try:
                ...
                # 获取建立websocket的请求链接
                socket_url = self.exchange.get("socket_url_spot").format(self.req)
                self.logger.info(socket_url)
    ...
    def save_result_redis(self, result):
        ...
        if result.get("data"):
            ...
            item["Volume"] = eval(tick.get("q"))
            # print(item)

            redis_key_name = "binance:spot:kline:{}_{}_1min_kline".format(self.pair1, self.pair2)
            redis_key_name2 = "yuanhao:binance:spot:kline:{}_{}_1min_kline".format(self.pair1, self.pair2)
...
if __name__ == "__main__":
    ...
    for kline_info in kline_info_spot:
        ...
        # print(req)
        spider = BinanceKlineSpider(logger, symbol, exchange, req, kline_type, pair1, pair2)
