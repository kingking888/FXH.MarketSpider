...
class HuobiProKlineSpider(object):
    ...
    def save_result_redis(self, result):
        ...
        if result.get("ch"):
            ...
            item["Amount"] = tick.get("amount")  # 成交量
            item["Volume"] = tick.get("vol")   # 成交额
            # print(item)

            redis_key_name = "huobipro:spot:kline:{}_{}_1min_kline".format(self.pair1, self.pair2)
            redis_key_name2 = "yuanhao:huobipro:spot:kline:{}_{}_1min_kline".format(self.pair1, self.pair2)
    ...
    if pair_url_spot:
        ...
        for kline_info in kline_info_spot:
            ...
            for index, symbol in enumerate(symbol_list):
                ...
                spider = HuobiProKlineSpider(logger, symbol[0], exchange, req, kline_type, pair1, pair2)
